...
#> 1 x->m->y | w: M+1.0SD M+1.0SD  1.060 0.212  0.081 0.408 0.800  0.028 0.438
#> 2    x->m->y | w: Mean    Mean  0.061 0.132  0.033 0.254 0.800  0.160 0.275
#> 3 x->m->y | w: M-1.0SD M-1.0SD -0.939 0.053 -0.093 0.192 0.000  0.172 0.112
#>     y~m
#> 1 0.474
#> 2 0.474
#> 3 0.474
