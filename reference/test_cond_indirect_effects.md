...
#> 1 x->m->y | w: M+1.0SD M+1.0SD  1.060 0.212  0.072 0.368 0.800  0.036 0.438
#> 2    x->m->y | w: Mean    Mean  0.061 0.132  0.034 0.245 0.800  0.192 0.275
#> 3 x->m->y | w: M-1.0SD M-1.0SD -0.939 0.053 -0.095 0.206 0.000  0.164 0.112
#>     y~m
#> 1 0.474
#> 2 0.474
#> 3 0.474
