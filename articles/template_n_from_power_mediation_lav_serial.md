...
#> - not significantly different from 0.800: 228 to 269
#> - significantly lower than 0.800: 228
#> - significantly higher than 0.800: 269
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (228): [0.714, 0.783]
#> - for the upper bound (269): [0.780, 0.842]
#> 
...
- sample sizes higher than 269 have power significantly higher than .80.

In other words, sample sizes between 228 and 269 have power not
...
#> - Time spent in the search: 1.772 mins 
...
#> Null Deviance:       2121 
#> Residual Deviance: 2078  AIC: 2082
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m1->m2->m3->y 
...
#> 2 228 0.040 1.000  0.750  0.714  0.783
#> 3 255 0.040 1.000  0.795  0.761  0.825
#> Notes:
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 269
#> 
#> - Final Estimated Power: 0.813 
#> - Confidence Interval: [0.780; 0.842]
#> - Level of confidence: 95.0%
#> - Based on 600 replications.
#> 
#> === Technical Information ===
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 200 to 269 
#> - Time spent in the search: 55.42 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:       2719 
#> Residual Deviance: 2657  AIC: 2661
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m1->m2->m3->y 
...
#> 2 228 0.040 1.000  0.750  0.714  0.783
#> 3 255 0.040 1.000  0.795  0.761  0.825
#> 4 269 0.040 1.000  0.813  0.780  0.842
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
