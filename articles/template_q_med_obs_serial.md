...
![The Model](template_q_med_obs_serial_model-1.png)
...
![The Model](template_q_med_obs_serial_model_es-1.png)
...
In this example, the power is about 0.71 for sample size 100, 95%
confidence interval \[0.67, 0.74\].
...
In this example, the range of the sample size is 113 to 125.
...
Searched](template_q_med_obs_serial_model_region-1.png)
