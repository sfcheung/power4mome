...
The estimated sample size is 103. The estimated power based on
simulation is 0.814, with its confidence interval equal to \[0.797,
0.831\].
...
crude model intended only for the values of sample size examined (9 in
