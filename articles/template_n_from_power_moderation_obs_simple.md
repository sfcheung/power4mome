...
#> The models:
#> y ~ x + w + x:w
#> <environment: 0x000001883676cb28>
#> 
#> 
...
#> - not significantly different from 0.800: 289 to 354
#> - significantly lower than 0.800: 289
#> - significantly higher than 0.800: 354
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (289): [0.714, 0.783]
#> - for the upper bound (354): [0.812, 0.870]
#> 
...
- sample sizes lower than 289 have power significantly lower than .80,
  and

- sample sizes higher than 354 have power significantly higher than .80.

In other words, sample sizes between 289 and 354 have power not
...
#> - Time spent in the search: 22.88 secs 
...
#> Null Deviance:       3660 
#> Residual Deviance: 3541  AIC: 3545
#> 
#> - Detailed Results:
#> 
#> [test]: test_parameters: CIs (pars: y~x:w) 
...
#> 3 280 0.152 1.000  0.740  0.703  0.773
#> 4 289 0.149 1.000  0.750  0.714  0.783
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 354
#> 
#> - Final Estimated Power: 0.843 
#> - Confidence Interval: [0.812; 0.870]
#> - Level of confidence: 95.0%
#> - Based on 600 replications.
#> 
#> === Technical Information ===
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 164 to 674 
#> - Time spent in the search: 36.65 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#>   -1.437562     0.008766  
#> 
#> Degrees of Freedom: 6599 Total (i.e. Null);  6598 Residual
#> Null Deviance:       7354 
#> Residual Deviance: 6672  AIC: 6676
#> 
#> - Detailed Results:
#> 
#> [test]: test_parameters: CIs (pars: y~x:w) 
#> [test_label]: y~x:w 
#>      n   est   p.v reject r.cilo r.cihi
#> 1  164 0.153 1.000  0.522  0.482  0.561
#> 2  200 0.142 1.000  0.533  0.493  0.573
#> 3  250 0.148 1.000  0.677  0.638  0.713
#> 4  280 0.152 1.000  0.740  0.703  0.773
#> 5  289 0.149 1.000  0.750  0.714  0.783
#> 6  300 0.151 1.000  0.805  0.771  0.835
#> 7  306 0.148 1.000  0.767  0.731  0.799
#> 8  312 0.149 1.000  0.793  0.759  0.824
#> 9  354 0.151 1.000  0.843  0.812  0.870
#> 10 416 0.149 1.000  0.882  0.853  0.905
#> 11 674 0.149 1.000  0.990  0.978  0.995
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
