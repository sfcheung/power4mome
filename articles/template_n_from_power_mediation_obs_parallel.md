...
#> - not significantly different from 0.800: 433 to 500
#> - significantly lower than 0.800: 433
#> - significantly higher than 0.800: 500
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (433): [0.750, 0.816]
...
- sample sizes lower than 433 have power significantly lower than .80,
  and

- sample sizes higher than 500 have power significantly higher than .80.

In other words, sample sizes between 433 and 500 have power not
...
#> - Time spent in the search: 3.402 mins 
...
#> Null Deviance:       3500 
#> Residual Deviance: 3125  AIC: 3129
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirects: x-...->y 
...
#> 3 433  NaN 1.000  0.785  0.750  0.816
#> 4 500  NaN 1.000  0.825  0.793  0.853
#> 5 650  NaN 1.000  0.913  0.888  0.933
#> Notes:
...
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 200 to 650 
#> - Time spent in the search: 0.5518 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
