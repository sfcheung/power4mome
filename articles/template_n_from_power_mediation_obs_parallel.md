# Quick Template: Parallel Mediation with Observed Variables
...
![The Model](template_n_from_power_mediation_obs_parallel_model-1.png)
...
#> - not significantly different from 0.800: 464 to 516
#> - significantly lower than 0.800: 464
#> - significantly higher than 0.800: 516
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (464): [0.724, 0.806]
#> - for the upper bound (516): [0.806, 0.877]
#> 
...
![Power Curve](template_n_from_power_mediation_obs_parallel_plot-1.png)

Power Curve

As shown above, approximately:

- sample sizes lower than 464 have power significantly lower than .80,
  and

- sample sizes higher than 516 have power significantly higher than .80.

In other words, sample sizes between 464 and 516 have power not
...
#> - Time spent in the search: 33.31 secs 
...
#> 1 100  NaN 1.000  0.172  0.139  0.213
#> 2 464  NaN 1.000  0.767  0.724  0.806
#> Notes:
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 516
#> 
#> - Final Estimated Power: 0.845 
#> - Confidence Interval: [0.806; 0.877]
#> - Level of confidence: 95.0%
#> - Based on 400 replications.
#> 
#> === Technical Information ===
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 464 to 738 
#> - Time spent in the search: 2.796 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:       1965 
#> Residual Deviance: 1906  AIC: 1910
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirects: x-...->y 
#> [test_label]: x-...->y (All sig) 
#>     n  est   p.v reject r.cilo r.cihi
#> 1 464  NaN 1.000  0.767  0.724  0.806
#> 2 484  NaN 1.000  0.820  0.779  0.855
#> 3 516  NaN 1.000  0.845  0.806  0.877
#> 4 548  NaN 1.000  0.873  0.836  0.902
#> 5 611  NaN 1.000  0.900  0.867  0.926
#> 6 738  NaN 1.000  0.940  0.912  0.959
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
