...
#> 1 0.171 0.998  0.548  0.508  0.587
#> Notes:
...
#> - not significantly different from 0.800: 150 to 187
#> - significantly lower than 0.800: 150
#> - significantly higher than 0.800: 187
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (150): [0.750, 0.816]
#> - for the upper bound (187): [0.819, 0.876]
#> 
...
- sample sizes lower than 150 have power significantly lower than .80,
  and

- sample sizes higher than 187 have power significantly higher than .80.

In other words, sample sizes between 150 and 187 have power not
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 150
#> 
#> - Final Estimated Power: 0.785 
#> - Confidence Interval: [0.750; 0.816]
...
#> - Time spent in the search: 2.627 mins 
...
#> Null Deviance:       4385 
#> Residual Deviance: 4094  AIC: 4098
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m->y 
...
#> 1 100 0.171 0.998  0.548  0.508  0.587
#> 2 146 0.164 1.000  0.747  0.710  0.780
#> 3 150 0.166 1.000  0.785  0.750  0.816
#> 4 153 0.168 1.000  0.807  0.773  0.836
#> 5 161 0.164 1.000  0.813  0.780  0.842
#> 6 187 0.161 1.000  0.850  0.819  0.876
#> 7 228 0.166 1.000  0.937  0.914  0.954
#> Notes:
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 187
#> 
#> - Final Estimated Power: 0.850 
#> - Confidence Interval: [0.819; 0.876]
#> - Level of confidence: 95.0%
#> - Based on 600 replications.
#> 
#> === Technical Information ===
...
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 100 to 228 
#> - Time spent in the search: 0.1357 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
