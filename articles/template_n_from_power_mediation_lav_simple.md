...
#> 1 0.171 0.998  0.544  0.504  0.584
#> Notes:
...
#> - not significantly different from 0.800: 147 to 164
#> - significantly lower than 0.800: 147
#> - significantly higher than 0.800: 164
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (147): [0.717, 0.786]
#> - for the upper bound (164): [0.789, 0.850]
#> 
...
- sample sizes lower than 147 have power significantly lower than .80,
  and

- sample sizes higher than 164 have power significantly higher than .80.

In other words, sample sizes between 147 and 164 have power not
...
#> 
#> - Final Estimated Power: 0.753 
#> - Confidence Interval: [0.717; 0.786]
...
#> - Time spent in the search: 28.46 secs 
...
#> Null Deviance:       1555 
#> Residual Deviance: 1497  AIC: 1501
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m->y 
...
#> 1 100 0.171 0.998  0.544  0.504  0.584
#> 2 147 0.164 1.000  0.753  0.717  0.786
#> Notes:
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 100 to 164 
#> - Time spent in the search: 27.69 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:       2178 
#> Residual Deviance: 2060  AIC: 2064
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m->y 
...
#> 1 100 0.171 0.998  0.544  0.504  0.584
#> 2 147 0.164 1.000  0.753  0.717  0.786
#> 3 164 0.166 1.000  0.822  0.789  0.850
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
