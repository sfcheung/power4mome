# Quick Template: Simple Mediation with Observed Variables
...
![The Model](template_n_from_power_mediation_obs_simple_model-1.png)
...
#> m    1 240000    0  1  0.00    -0.01  0
#> y    2 240000    0  1  0.00    -0.02  0
#> x    3 240000    0  1 -0.01     0.00  0
#> 
...
#> 1 0.051 1.000  0.538  0.498  0.578
#> Notes:
...
#> - not significantly different from 0.800: 743 to 827
#> - significantly lower than 0.800: 743
#> - significantly higher than 0.800: 827
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (743): [0.736, 0.803]
#> - for the upper bound (827): [0.791, 0.852]
#> 
...
![Power Curve](template_n_from_power_mediation_obs_simple_plot-1.png)

Power Curve

As shown above, approximately:

- sample sizes lower than 743 have power significantly lower than .80,
  and

- sample sizes higher than 827 have power significantly higher than .80.

In other words, sample sizes between 743 and 827 have power not
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 743
#> 
#> - Final Estimated Power: 0.772 
#> - Confidence Interval: [0.736; 0.803]
...
#> - The range of values explored: 400 to 1059 
#> - Time spent in the search: 1.92 mins 
...
#> 1  400 0.051 1.000  0.538  0.498  0.578
#> 2  594 0.050 1.000  0.693  0.655  0.729
#> 3  724 0.049 1.000  0.733  0.697  0.767
#> 4  743 0.050 1.000  0.772  0.736  0.803
#> 5  762 0.050 1.000  0.793  0.759  0.824
#> 6  827 0.051 1.000  0.823  0.791  0.852
#> 7 1059 0.050 1.000  0.887  0.859  0.910
#> Notes:
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 827
#> 
#> - Final Estimated Power: 0.823 
#> - Confidence Interval: [0.791; 0.852]
#> - Level of confidence: 95.0%
#> - Based on 600 replications.
#> 
#> === Technical Information ===
...
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 400 to 1059 
#> - Time spent in the search: 0.1101 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
