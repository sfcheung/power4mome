...
#> - not significantly different from 0.800: 724 to 827
#> - significantly lower than 0.800: 724
#> - significantly higher than 0.800: 827
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (724): [0.712, 0.781]
...
- sample sizes lower than 724 have power significantly lower than .80,
  and

- sample sizes higher than 827 have power significantly higher than .80.

In other words, sample sizes between 724 and 827 have power not
...
#> 
#> - Final Estimated Power: 0.748 
#> - Confidence Interval: [0.712; 0.781]
...
#> - The range of values explored: 1059 to 827 
#> - Time spent in the search: 2.393 mins 
...
#> Null Deviance:       4066 
#> Residual Deviance: 3839  AIC: 3843
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m->y 
...
#> 3  724 0.049 1.000  0.748  0.712  0.781
#> 4  736 0.052 1.000  0.797  0.763  0.827
#> 5  827 0.051 1.000  0.823  0.791  0.852
#> 6 1059 0.050 1.000  0.887  0.859  0.910
#> Notes:
...
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 1059 to 827 
#> - Time spent in the search: 0.161 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
