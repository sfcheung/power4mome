...
``` r
out_power
#>                     test test_label pvalid reject reject_ci_lo reject_ci_hi
#> 1 test_indirect: x->m->y       Test      1 0.4675    0.4186045    0.5163955
```
...
out_power
#>                    test test_label pvalid reject reject_ci_lo reject_ci_hi
#> 1 test_moderation: CIs       y~x:w      1 0.1175    0.0859431    0.1490569
```
...
`x:w`, is
0.117, with 95% confidence
interval [0.086; 0.149].
...
out_new_n_reject
#>                    test test_label pvalid reject reject_ci_lo reject_ci_hi
#> 1 test_moderation: CIs       y~x:w      1  0.295    0.2503086    0.3396914
```



The estimated power is 0.295,
...
#> 1 test_index_of_mome: x->m->y, moderated by w       Test      1 0.0525
#>   reject_ci_lo reject_ci_hi
#> 1   0.03064316   0.07435684
```
...
0.052,
95% confidence interval [0.031; 0.074].
...
out_new_n_reject
#>                                          test test_label pvalid reject
#> 1 test_index_of_mome: x->m->y, moderated by w       Test      1 0.2125
#>   reject_ci_lo reject_ci_hi
#> 1    0.1724112    0.2525888
```



The estimated power is 0.212,
95% confidence interval [0.172; 0.253],
when the sample size is
