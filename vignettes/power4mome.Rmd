...
#> 1 test_indirect: x->m->y  Test      1   0.48
```
...
out_power
#>                                          test label pvalid reject
#> 1 test_index_of_mome: x->m->y, moderated by w  Test      1  0.068
```
...
out_new_n_reject
#>                                          test label pvalid reject
#> 1 test_index_of_mome: x->m->y, moderated by w  Test      1  0.224
```



The estimated power is 0.224
when the sample size is
