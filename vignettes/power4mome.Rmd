...
#> 1 test_indirect: x->m->y  Test      1   0.47
```
...
out_power
#>                    test label pvalid reject
#> 1 test_moderation: CIs  y~x:w      1   0.11
```
...
out_new_n_reject
#>                    test label pvalid reject
#> 1 test_moderation: CIs  y~x:w      1  0.294
```



The estimated power is 0.294
...
out_power
#>                                          test label pvalid reject
#> 1 test_index_of_mome: x->m->y, moderated by w  Test      1  0.066
```
...
out_new_n_reject
#>                                          test label pvalid reject
#> 1 test_index_of_mome: x->m->y, moderated by w  Test      1  0.222
```



The estimated power is 0.222
when the sample size is
