...
#> - Time spent in the search: 1.17 mins 
...
#> 3 691 0.050 1.000  0.752  0.710  0.795
#> 4 832 0.051 1.000  0.828  0.790  0.865
#> 5 972 0.048 1.000  0.845  0.810  0.880
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
...
#> 
#> - Algorithm: bisection 
#> - The range of values explored: 1036 to 788 
#> - Time spent in the search: 52.2 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> 3  788 0.051 1.000  0.825  0.788  0.862
#> 4 1036 0.050 1.000  0.887  0.857  0.918
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
...
#> - Time spent in the search: 1.649 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> 3 113 0.089 1.000  0.825  0.788  0.862
#> 4 119 0.089 1.000  0.858  0.823  0.892
#> 5 130 0.091 1.000  0.895  0.865  0.925
#> 6 152 0.091 1.000  0.938  0.914  0.961
#> 7 197 0.090 1.000  0.973  0.956  0.989
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
