...
```{r temp_med_obs_fig_flowchart, fig.cap="Common Workflow", echo=FALSE, fig.align="center", message=FALSE}
library(DiagrammeR)
...
#> - Time spent in the search: 2.26 mins
...
#> - Time spent in the search: 2.19 mins
#> - The final crude model for the power-predictor relation:
#>
#> Model Type: Logistic Regression
#>
...
#> === Technical Information ===
#>
#> - The range of values explored: 96 to 127
#> - Time spent in the search: 2.156 mins
#> - The final crude model for the power-predictor relation:
#>
#> Model Type: Logistic Regression
#>
...
#>
#>     n                   test test_label   p.v reject r.cilo r.cihi
#> 1  96 test_indirect: x->m->y       Test 1.000  0.780  0.739  0.821
#> 2 100 test_indirect: x->m->y       Test 1.000  0.745  0.702  0.788
...
#> 6 109 test_indirect: x->m->y       Test 1.000  0.755  0.695  0.815
#> 7 110 test_indirect: x->m->y       Test 1.000  0.812  0.774  0.851
#> 8 116 test_indirect: x->m->y       Test 1.000  0.876  0.813  0.939
#> 9 127 test_indirect: x->m->y       Test 1.000  0.863  0.829  0.896
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
