...
#> - Time spent in the search: 1.995 mins 
...
#> 2 410 test_indirect: x->m->y       Test 1.000  0.537  0.489  0.586
#> 3 691 test_indirect: x->m->y       Test 1.000  0.752  0.710  0.795
#> 4 832 test_indirect: x->m->y       Test 1.000  0.828  0.790  0.865
#> 5 972 test_indirect: x->m->y       Test 1.000  0.845  0.810  0.880
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
...
#> === Technical Information ===
#> 
#> - The range of values explored: 300 to 1036 
#> - Time spent in the search: 1.387 mins 
#> - The final crude model for the power-predictor relation:
#> 
...
#> 
#>      n                   test test_label   p.v reject r.cilo r.cihi
#> 1  300 test_indirect: x->m->y       Test 1.000  0.445  0.396  0.494
#> 2  539 test_indirect: x->m->y       Test 1.000  0.662  0.616  0.709
#> 3  788 test_indirect: x->m->y       Test 1.000  0.825  0.788  0.862
#> 4 1036 test_indirect: x->m->y       Test 1.000  0.887  0.857  0.918
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
...
#> === Technical Information ===
#> 
#> - The range of values explored: 100 to 197 
#> - Time spent in the search: 2.776 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:	    2311 
#> Residual Deviance: 2158 	AIC: 2162
#> 
#> - Detailed Results:
#> 
#>     n                   test test_label   p.v reject r.cilo r.cihi
#> 1 100 test_indirect: x->m->y       Test 1.000  0.745  0.702  0.788
#> 2 107 test_indirect: x->m->y       Test 1.000  0.757  0.715  0.800
#> 3 113 test_indirect: x->m->y       Test 1.000  0.825  0.788  0.862
#> 4 119 test_indirect: x->m->y       Test 1.000  0.858  0.823  0.892
#> 5 130 test_indirect: x->m->y       Test 1.000  0.895  0.865  0.925
#> 6 152 test_indirect: x->m->y       Test 1.000  0.938  0.914  0.961
#> 7 197 test_indirect: x->m->y       Test 1.000  0.973  0.956  0.989
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
