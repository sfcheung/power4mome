...
#> 
#> - The range of values explored: 50 to 126 
#> - Time spent in the search: 2.122 mins 
...
#> Null Deviance:	    321.8 
#> Residual Deviance: 306.2 	AIC: 310.2
#> 
#> - Detailed Results:
#> 
#>     n                   test test_label   p.v reject r.cilo r.cihi
#> 1  50 test_indirect: x->m->y       Test 1.000  0.400  0.264  0.536
#> 2  75 test_indirect: x->m->y       Test 1.000  0.690  0.599  0.781
#> 3  89 test_indirect: x->m->y       Test 1.000  0.772  0.731  0.814
#> 4  96 test_indirect: x->m->y       Test 1.000  0.720  0.632  0.808
#> 5 100 test_indirect: x->m->y       Test 1.000  0.750  0.665  0.835
#> 6 103 test_indirect: x->m->y       Test 1.000  0.782  0.742  0.823
#> 7 104 test_indirect: x->m->y       Test 1.000  0.855  0.810  0.899
#> 8 114 test_indirect: x->m->y       Test 1.000  0.780  0.699  0.861
#> 9 126 test_indirect: x->m->y       Test 1.000  0.870  0.837  0.903
#> Notes:
