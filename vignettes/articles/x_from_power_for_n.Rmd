...
how `x_from_power()` works when our goal
...
- `goal`: To get the "close enough" solution,
  set `goal` to `"close_enough"`. By default,
  close enough is defined as "within .02
...
#>     goal = "close_enough", final_nrep = 400, seed = 4567)
#> 
#>                           Setting
...
#> - The range of values explored: 105 to 91 
#> - Time spent in the search: 1.729 mins 
...
#>    -1.07476      0.02389  
#> 
#> Degrees of Freedom: 1649 Total (i.e. Null);  1648 Residual
#> Null Deviance:	    1759 
#> Residual Deviance: 1686 	AIC: 1690
#> 
#> - Detailed Results:
#> 
#>     n                   test test_label   p.v reject r.cilo r.cihi
#> 1  50 test_indirect: x->m->y       Test 1.000  0.520  0.382  0.658
#> 2  77 test_indirect: x->m->y       Test 1.000  0.685  0.639  0.731
#> 3  91 test_indirect: x->m->y       Test 1.000  0.748  0.705  0.790
#> 4 105 test_indirect: x->m->y       Test 1.000  0.810  0.772  0.848
#> 5 133 test_indirect: x->m->y       Test 1.000  0.890  0.859  0.921
#> Notes:
...
#>     goal = "close_enough", final_nrep = 400, seed = 2345)
#> 
#>                           Setting
#> Predictor(x):         Sample Size
#> Parameter:                    N/A
...
#> Target Power:               0.800
#> 
#> - Final Value of Sample Size (n): 114
#> 
#> - Final Estimated Power (CI): 0.845 [0.810, 0.880]
#> 
#> Call `summary()` for detailed results.
```

The estimated sample size is
114. The estimated power
based on simulation is
0.845,
with its confidence interval equal to
[0.810, 0.790].
The upper bound, 0.810,
is .02 within the target power (.80).

With 400 replications,
it is estimated that sample sizes
greater than 114 have power
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 109 to 98 
#> - Time spent in the search: 2.456 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:	    2381 
#> Residual Deviance: 2254 	AIC: 2258
#> 
#> - Detailed Results:
#> 
#>     n                   test test_label   p.v reject r.cilo r.cihi
#> 1  50 test_indirect: x->m->y       Test 1.000  0.520  0.382  0.658
#> 2  77 test_indirect: x->m->y       Test 1.000  0.672  0.627  0.718
#> 3  98 test_indirect: x->m->y       Test 1.000  0.775  0.734  0.816
#> 4 109 test_indirect: x->m->y       Test 1.000  0.815  0.777  0.853
#> 5 114 test_indirect: x->m->y       Test 1.000  0.845  0.810  0.880
#> 6 119 test_indirect: x->m->y       Test 1.000  0.855  0.820  0.890
#> 7 161 test_indirect: x->m->y       Test 1.000  0.935  0.911  0.959
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
...
<div class="figure" style="text-align: center">
<img src="x_from_power_for_n_lb_plot-1.png" alt="The Power Curve"  />
<p class="caption">The Power Curve</p>
</div>
