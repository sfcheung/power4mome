...
`power4test()`
(see this [get-started](https://sfcheung.github.io/power4mome/power4mome.html)
for an introduction).
...
#> - Time spent in the search: 3.173 mins 
...
#> - Detailed Results:
#> 
#>     n                   test test_label pvalid reject reject_ci_lo reject_ci_hi
#> 1  50 test_indirect: x->m->y       Test      1  0.400        0.264        0.536
#> 2  75 test_indirect: x->m->y       Test      1  0.700        0.573        0.827
#> 3  81 test_indirect: x->m->y       Test      1  0.682        0.637        0.728
#> 4  97 test_indirect: x->m->y       Test      1  0.786        0.678        0.893
#> 5 100 test_indirect: x->m->y       Test      1  0.740        0.618        0.862
#> 6 103 test_indirect: x->m->y       Test      1  0.782        0.742        0.823
#> 7 104 test_indirect: x->m->y       Test      1  0.861        0.812        0.910
#> 8 113 test_indirect: x->m->y       Test      1  0.792        0.683        0.902
#> 9 131 test_indirect: x->m->y       Test      1  0.882        0.851        0.914
```
