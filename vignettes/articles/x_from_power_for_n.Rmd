...
#> - Time spent in the search: 1.717 mins 
...
#> 1  50 0.167 1.000  0.520  0.382  0.658
#> 2  77 0.147 1.000  0.685  0.639  0.731
#> 3  91 0.145 1.000  0.748  0.705  0.790
#> 4 105 0.153 1.000  0.810  0.772  0.848
#> 5 133 0.152 1.000  0.890  0.859  0.921
#> Notes:
...
#> - Time spent in the search: 2.282 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#>     n   est   p.v reject r.cilo r.cihi
#> 1  50 0.167 1.000  0.520  0.382  0.658
#> 2  77 0.151 1.000  0.672  0.627  0.718
#> 3  98 0.147 1.000  0.775  0.734  0.816
#> 4 109 0.151 1.000  0.815  0.777  0.853
#> 5 114 0.151 1.000  0.845  0.810  0.880
#> 6 119 0.149 1.000  0.855  0.820  0.890
#> 7 161 0.150 1.000  0.935  0.911  0.959
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
