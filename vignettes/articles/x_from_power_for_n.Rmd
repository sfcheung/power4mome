---
title: "Sample Size Given Desired Power (Informal Bisection)"
date: "2026-03-04"
output:
...
vignette: >
  %\VignetteIndexEntry{Sample Size Given Desired Power (Informal Bisection)}
...
The
[other version](./x_from_power_for_n_pb.html)
uses the probabilistic bisection algorithm
...
The estimated sample size is
115. The estimated power
based on simulation is
0.838,
with its confidence interval equal to
[0.798, 0.785].
The upper bound, 0.798,
is .02 within the target power (.80).

With 400 replications,
it is estimated that sample sizes
greater than 115 have power
