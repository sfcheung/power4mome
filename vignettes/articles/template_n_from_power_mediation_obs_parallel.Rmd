...
# ====== Estimate the Power ======
# For n = 50,
# when testing one indirect effect by
...
#> m1    1 20000 -0.01 1.01 0.04    -0.01 0.01
#> m2    2 20000  0.00 1.00 0.02     0.05 0.01
#> m3    3 20000 -0.01 1.00 0.00    -0.05 0.01
#> y     4 20000 -0.01 1.00 0.01    -0.02 0.01
...
#> ====================== Test(s) Conducted ======================
#> 
#> - test_indirect: x->m2->y
#> 
#> Call print() and set 'test_long = TRUE' for a detailed report.
rejection_rates(out)
#> [test]: test_indirect: x->m2->y 
#> [test_label]: Test 
#>     est   p.v reject r.cilo r.cihi
#> 1 0.090 1.000  0.432  0.384  0.481
#> Notes:
...
#> [test_label]: Test 
#>     est   p.v reject r.cilo r.cihi
#> 1 0.092 1.000  0.953  0.932  0.973
#> Notes:
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
#> - reject: The proportion of 'significant' replications, that is, the
...
#> - The range of values explored: 50 to 92 
#> - Time spent in the search: 1.232 mins 
...
#> Null Deviance:	    2569 
#> Residual Deviance: 2428 	AIC: 2432
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m2->y 
...
#> 1 50 0.090 1.000  0.432  0.384  0.481
#> 2 71 0.090 1.000  0.610  0.562  0.658
#> 3 82 0.088 1.000  0.703  0.658  0.747
#> 4 87 0.087 1.000  0.762  0.721  0.804
#> 5 92 0.089 1.000  0.782  0.742  0.823
#> Notes:
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 100 to 92 
#> - Time spent in the search: 1.464 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#>     n   est   p.v reject r.cilo r.cihi
#> 1  50 0.090 1.000  0.432  0.384  0.481
#> 2  92 0.089 1.000  0.782  0.742  0.823
#> 3 100 0.089 1.000  0.838  0.801  0.874
#> 4 107 0.090 1.000  0.880  0.848  0.912
#> 5 121 0.087 1.000  0.877  0.845  0.910
#> 6 149 0.089 1.000  0.958  0.938  0.977
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
...
For example, reduce the path from
`m2` to `y` to small:
...
#> 
#>    vars     n  mean sd  skew kurtosis   se
#> m1    1 40000  0.00  1  0.00     0.01 0.00
#> m2    2 40000  0.00  1 -0.01     0.01 0.01
#> m3    3 40000  0.00  1  0.02     0.01 0.01
#> y     4 40000 -0.01  1  0.00     0.02 0.01
...
#> [test_label]: Test 
#>     est   p.v reject r.cilo r.cihi
#> 1 0.029 1.000  0.182  0.145  0.220
#> Notes:
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
#> - reject: The proportion of 'significant' replications, that is, the
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 100 to 777 
#> - Time spent in the search: 1.188 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Degrees of Freedom: 1999 Total (i.e. Null);  1998 Residual
#> Null Deviance:	    2567 
#> Residual Deviance: 1979 	AIC: 1983
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m2->y 
#> [test_label]: Test 
#>     n   est   p.v reject r.cilo r.cihi
#> 1 100 0.029 1.000  0.182  0.145  0.220
#> 2 438 0.030 1.000  0.642  0.596  0.689
#> 3 523 0.030 1.000  0.745  0.702  0.788
#> 4 608 0.029 1.000  0.810  0.772  0.848
#> 5 777 0.031 1.000  0.915  0.888  0.942
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 100 to 887 
#> - Time spent in the search: 1.54 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> 1 100 0.029 1.000  0.182  0.145  0.220
#> 2 438 0.030 1.000  0.642  0.596  0.689
#> 3 551 0.029 1.000  0.767  0.726  0.809
#> 4 607 0.030 1.000  0.853  0.818  0.887
#> 5 663 0.030 1.000  0.863  0.829  0.896
#> 6 887 0.030 1.000  0.955  0.935  0.975
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
