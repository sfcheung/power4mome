...
library(DiagrammeR)
# https://mermaid.live/edit#pako:eNqFVF1v2jAU_SuWpUogAQUSIKQUaRp7bFeNag9bpsgkNx-SY0eOsy6l_Pc5NslCSrU32_ec43PPtXzEAQ8Buzii_CVIiJDoeecxjyEUUFIUO4hQCBEpqURRSqlL0ziRB1rC3TXMvAOKBQC7M1qFrCggKSpmAEgjKqDq1n_1TFmh1wA1ZA_yoa4PPLyDIA2VXALoieclJTLlDOkqGmzSrdbZ3KbboYeHZ-6X_YfE70S1U2hmznMfii71K4NHxXwWFeIMENscxO1WI19A2BIKORjW-DP85kZd9hsEoQ2rMFvEivdU_1D57IK_ByKCpOaalfYqIFY-C8SjjgrzzbEfCZ75WrPv5BPjii4aJ8Rs_9ODHkd5iAXJk_NEfhq-igI9evjX5Txc122HPx5vTdadwzZ_Xa3jNHxgoVkoo_UpGk8ads-Efja1BxXFN91zncSeZLl6M_v0FYrWlBHSOjrHTqT18ZtuQ4fwbv5v3bsbT5v7-20bYy9VU2ym_UGxdXGh2CN1C11CA-vV-um1d3YTvBS4UjmH0hbwCGcgMpKG6jc41jAPK9kMPOyq5XmcHvbYSUFJKfm-YgF2pShhhAUv4wS7EaGF2pV5SCTsUqIGmLWnOWE_OM8aCoSp5OLBfD_6F9IQ7B7xH-zO5qvJdLm0ZgtnvVw71mqEK-wu7MlqvbKmq7nj2LOVY51G-FVrTieONbOnC3s5dSx7MbXmIxyLupmzQZUYiM-8ZFKJW6e_bFKaVg
mermaid('
flowchart TD
...
#> - not significantly different from 0.800: 464 to 484
#> - significantly lower than 0.800: 464
#> - significantly higher than 0.800: 484
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (464): [0.726, 0.809]
#> - for the upper bound (484): [0.782, 0.858]
#> 
...
<img src="template_n_from_power_mediation_obs_parallel_plot1-1.png" alt="Power Curve"  />
...
#> - Time spent in the search: 30.98 secs 
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 484
#> 
#> - Final Estimated Power: 0.820 
#> - Confidence Interval: [0.782; 0.858]
#> - Level of confidence: 95.0%
#> - Based on 400 replications.
#> 
#> === Technical Information ===
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 464 to 484 
#> - Time spent in the search: 31.37 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Degrees of Freedom: 799 Total (i.e. Null);  798 Residual
#> Null Deviance:	    814.3 
#> Residual Deviance: 810.9 	AIC: 814.9
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirects: x-...->y 
#> [test_label]: x-...->y (All sig) 
#>     n  est   p.v reject r.cilo r.cihi
#> 1 464  NaN 1.000  0.767  0.726  0.809
#> 2 484  NaN 1.000  0.820  0.782  0.858
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
