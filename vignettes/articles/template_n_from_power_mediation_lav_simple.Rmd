...
#> - for the lower bound (145): [0.726, 0.809]
#> - for the upper bound (182): [0.807, 0.878]
#> 
...
#> - Time spent in the search: 58.24 secs 
...
#> 2 130 0.167 1.000  0.708  0.663  0.752
#> 3 145 0.159 1.000  0.767  0.726  0.809
#> 4 160 0.164 1.000  0.807  0.769  0.846
#> Notes:
...
#> - Confidence Interval: [0.807; 0.878]
#> - Level of confidence: 95.0%
#> - Based on 400 replications.
#> 
#> === Technical Information ===
...
#> - Time spent in the search: 1.287 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> [test_label]: Test 
#>     n   est   p.v reject r.cilo r.cihi
#> 1 159 0.157 1.000  0.797  0.758  0.837
#> 2 160 0.164 1.000  0.807  0.769  0.846
#> 3 182 0.157 1.000  0.843  0.807  0.878
#> 4 203 0.162 1.000  0.902  0.873  0.932
#> 5 245 0.156 1.000  0.953  0.932  0.973
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
