...
#> 1 0.077 1.000  0.370  0.323  0.417
#> Notes:
...
#> - not significantly different from 0.800: 304 to 357
#> - significantly lower than 0.800: 304
#> - significantly higher than 0.800: 357
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (304): [0.723, 0.807]
#> - for the upper bound (357): [0.804, 0.876]
#> 
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 304
#> 
#> - Final Estimated Power: 0.765 
#> - Confidence Interval: [0.723; 0.807]
...
#> - The range of values explored: 100 to 391 
#> - Time spent in the search: 1.63 mins 
...
#> Null Deviance:	    2042 
#> Residual Deviance: 1786 	AIC: 1790
#> 
#> - Detailed Results:
#> 
#> [test]: test_index_of_mome: x->m->y, moderated by w 
...
#> 1 100 0.077 1.000  0.370  0.323  0.417
#> 2 216 0.076 1.000  0.647  0.601  0.694
#> 3 304 0.074 1.000  0.765  0.723  0.807
#> 4 391 0.075 1.000  0.875  0.843  0.907
#> Notes:
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 357 to 391 
#> - Time spent in the search: 31.95 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:	    655.2 
#> Residual Deviance: 653.2 	AIC: 657.2
#> 
#> - Detailed Results:
#> 
#> [test]: test_index_of_mome: x->m->y, moderated by w 
#> [test_label]: Test 
#>     n   est   p.v reject r.cilo r.cihi
#> 1 357 0.074 1.000  0.840  0.804  0.876
#> 2 391 0.075 1.000  0.875  0.843  0.907
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
