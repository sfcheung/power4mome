---
title: "Quick Template: Simple Moderated Mediation with Observed Variables: a-Path Moderated"
date: "2025-07-22"
output:
  html_document:
    fig.align: "center"
...
<img src="template_n_from_power_mome_obs_a_model-1.png" alt="The Model"  />
...
#> 
#>       [w]    (w)   ind   m~x   y~m
#> 1 M+1.0SD  0.964 0.222 0.445 0.500
#> 2 Mean    -0.086 0.144 0.287 0.500
#> 3 M-1.0SD -1.135 0.065 0.130 0.500
#> 
...
#> 
#>       [x]    (x)    ind    m~w   y~m
#> 1 M+1.0SD  1.150  0.136  0.273 0.500
#> 2 Mean     0.132  0.060  0.120 0.500
#> 3 M-1.0SD -0.887 -0.017 -0.033 0.500
#> 
#>  - The 'ind' column shows the conditional indirect effects.
...
#> 1 0.077 1.000  0.362  0.315  0.410
#> Notes:
...
#> - not significantly different from 0.800: 268 to 366
#> - significantly lower than 0.800: 268
#> - significantly higher than 0.800: 366
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (268): [0.702, 0.788]
#> - for the upper bound (366): [0.815, 0.885]
#> 
...
<div class="figure" style="text-align: center">
<img src="template_n_from_power_mome_obs_a_plot-1.png" alt="Power Curve"  />
...
#> - The range of values explored: 100 to 406 
#> - Time spent in the search: 2.239 mins 
...
#> Null Deviance:	    2487 
#> Residual Deviance: 2187 	AIC: 2191
#> 
#> - Detailed Results:
#> 
#> [test]: test_index_of_mome: x->m->y, moderated by w 
...
#> 1 100 0.077 1.000  0.362  0.315  0.410
#> 2 221 0.074 1.000  0.640  0.593  0.687
#> 3 268 0.075 1.000  0.745  0.702  0.788
#> 4 314 0.078 1.000  0.797  0.758  0.837
#> 5 406 0.074 1.000  0.887  0.857  0.918
#> Notes:
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 366 to 406 
#> - Time spent in the search: 32.85 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:	    622 
#> Residual Deviance: 619.5 	AIC: 623.5
#> 
#> - Detailed Results:
#> 
#> [test]: test_index_of_mome: x->m->y, moderated by w 
#> [test_label]: Test 
#>     n   est   p.v reject r.cilo r.cihi
#> 1 366 0.075 1.000  0.850  0.815  0.885
#> 2 406 0.074 1.000  0.887  0.857  0.918
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
