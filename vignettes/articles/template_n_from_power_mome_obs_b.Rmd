...
#> 1 0.046 1.000  0.295  0.250  0.340
#> Notes:
...
#> - not significantly different from 0.800: 290 to 346
#> - significantly lower than 0.800: 290
#> - significantly higher than 0.800: 346
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (290): [0.729, 0.811]
#> - for the upper bound (346): [0.804, 0.876]
#> 
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 290
#> 
#> - Final Estimated Power: 0.770 
#> - Confidence Interval: [0.729; 0.811]
...
#> - The range of values explored: 100 to 420 
#> - Time spent in the search: 2.886 mins 
...
#> Null Deviance:	    2829 
#> Residual Deviance: 2395 	AIC: 2399
#> 
#> - Detailed Results:
#> 
#> [test]: test_index_of_mome: x->m->y, moderated by w 
...
#> 1 100 0.046 1.000  0.295  0.250  0.340
#> 2 271 0.046 1.000  0.735  0.692  0.778
#> 3 290 0.044 1.000  0.770  0.729  0.811
#> 4 309 0.045 1.000  0.805  0.766  0.844
#> 5 346 0.045 1.000  0.840  0.804  0.876
#> 6 420 0.047 1.000  0.897  0.868  0.927
#> Notes:
...
#> - The range of values explored: 100 to 420 
#> - Time spent in the search: 0.1294 secs 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
