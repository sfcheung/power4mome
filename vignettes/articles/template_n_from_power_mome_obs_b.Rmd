...
#> 1 0.046 1.000  0.287  0.243  0.332
#> Notes:
...
#> - not significantly different from 0.800: 278 to 357
#> - significantly lower than 0.800: 278
#> - significantly higher than 0.800: 357
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (278): [0.694, 0.781]
#> - for the upper bound (357): [0.818, 0.887]
#> 
...
#> - The range of values explored: 100 to 278 
#> - Time spent in the search: 35.12 secs 
...
#> Null Deviance:	    1109 
#> Residual Deviance: 940.4 	AIC: 944.4
#> 
#> - Detailed Results:
#> 
#> [test]: test_index_of_mome: x->m->y, moderated by w 
...
#> 1 100 0.046 1.000  0.287  0.243  0.332
#> 2 278 0.045 1.000  0.738  0.694  0.781
#> Notes:
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 278 to 520 
#> - Time spent in the search: 2.114 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:	    1765 
#> Residual Deviance: 1683 	AIC: 1687
#> 
#> - Detailed Results:
#> 
#> [test]: test_index_of_mome: x->m->y, moderated by w 
#> [test_label]: Test 
#>     n   est   p.v reject r.cilo r.cihi
#> 1 278 0.045 1.000  0.738  0.694  0.781
#> 2 302 0.045 1.000  0.772  0.731  0.814
#> 3 357 0.046 1.000  0.853  0.818  0.887
#> 4 411 0.044 1.000  0.897  0.868  0.927
#> 5 520 0.044 1.000  0.935  0.911  0.959
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
