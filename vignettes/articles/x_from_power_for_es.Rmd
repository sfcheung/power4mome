...
#> - Time spent in the search: 4.023 mins 
...
#> - Detailed Results:
#> 
#>    par    es                   test test_label pvalid reject reject_ci_lo reject_ci_hi
#> 1  m~x 0.287 test_indirect: x->m->y       Test      1  0.685        0.639        0.731
#> 2  m~x 0.287 test_indirect: x->m->y       Test      1  0.698        0.652        0.743
#> 3  m~x 0.300 test_indirect: x->m->y       Test      1  0.720        0.596        0.844
#> 4  m~x 0.312 test_indirect: x->m->y       Test      1  0.760        0.642        0.878
#> 5  m~x 0.317 test_indirect: x->m->y       Test      1  0.780        0.665        0.895
#> 6  m~x 0.325 test_indirect: x->m->y       Test      1  0.745        0.685        0.805
#> 7  m~x 0.327 test_indirect: x->m->y       Test      1  0.748        0.705        0.790
#> 8  m~x 0.330 test_indirect: x->m->y       Test      1  0.790        0.750        0.830
#> 9  m~x 0.333 test_indirect: x->m->y       Test      1  0.820        0.714        0.926
#> 10 m~x 0.340 test_indirect: x->m->y       Test      1  0.760        0.642        0.878
#> 11 m~x 0.372 test_indirect: x->m->y       Test      1  0.840        0.804        0.876
#> 12 m~x 0.374 test_indirect: x->m->y       Test      1  0.812        0.774        0.851
```
...
#> - Time spent in the search: 4.005 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> 
#>    par    es                   test test_label pvalid reject reject_ci_lo reject_ci_hi
#> 1  y~m 0.291 test_indirect: x->m->y       Test      1  0.703        0.658        0.747
#> 2  y~m 0.291 test_indirect: x->m->y       Test      1  0.698        0.652        0.743
#> 3  y~m 0.300 test_indirect: x->m->y       Test      1  0.720        0.596        0.844
#> 4  y~m 0.307 test_indirect: x->m->y       Test      1  0.720        0.596        0.844
#> 5  y~m 0.315 test_indirect: x->m->y       Test      1  0.730        0.668        0.792
#> 6  y~m 0.317 test_indirect: x->m->y       Test      1  0.820        0.714        0.926
#> 7  y~m 0.318 test_indirect: x->m->y       Test      1  0.750        0.708        0.792
#> 8  y~m 0.321 test_indirect: x->m->y       Test      1  0.767        0.726        0.809
#> 9  y~m 0.325 test_indirect: x->m->y       Test      1  0.760        0.642        0.878
#> 10 y~m 0.333 test_indirect: x->m->y       Test      1  0.860        0.764        0.956
#> 11 y~m 0.345 test_indirect: x->m->y       Test      1  0.850        0.815        0.885
#> 12 y~m 0.348 test_indirect: x->m->y       Test      1  0.823        0.785        0.860
```
