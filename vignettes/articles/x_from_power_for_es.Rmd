...
#> 
#> - The range of values explored: 0.467428819792921 to 0.533987987768478 
#> - Time spent in the search: 2.035 mins 
...
#> Null Deviance:	    238.7 
#> Residual Deviance: 238.6 	AIC: 242.6
#> 
#> - Detailed Results:
#> 
#>   par    es                   test test_label   p.v reject r.cilo r.cihi
#> 1 m~x 0.467 test_indirect: x->m->y       Test 1.000  0.802  0.763  0.842
#> 2 m~x 0.475 test_indirect: x->m->y       Test 1.000  0.810  0.733  0.887
#> 3 m~x 0.488 test_indirect: x->m->y       Test 1.000  0.830  0.756  0.904
#> 4 m~x 0.494 test_indirect: x->m->y       Test 1.000  0.800  0.722  0.878
#> 5 m~x 0.500 test_indirect: x->m->y       Test 1.000  0.820  0.714  0.926
#> 6 m~x 0.500 test_indirect: x->m->y       Test 1.000  0.782  0.742  0.823
#> 7 m~x 0.504 test_indirect: x->m->y       Test 1.000  0.808  0.759  0.857
#> 8 m~x 0.528 test_indirect: x->m->y       Test 1.000  0.730  0.643  0.817
#> 9 m~x 0.534 test_indirect: x->m->y       Test 1.000  0.775  0.734  0.816
#> Notes:
...
#> === Technical Information ===
#> 
#> - The range of values explored: 0.268990058067128 to 0.33332571010882 
#> - Time spent in the search: 2.035 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
...
#> Degrees of Freedom: 249 Total (i.e. Null);  248 Residual
#> Null Deviance:	    252.9 
#> Residual Deviance: 252.9 	AIC: 256.9
#> 
#> - Detailed Results:
#> 
#>   par    es                   test test_label   p.v reject r.cilo r.cihi
#> 1 y~m 0.269 test_indirect: x->m->y       Test 1.000  0.690  0.645  0.735
#> 2 y~m 0.274 test_indirect: x->m->y       Test 1.000  0.640  0.546  0.734
#> 3 y~m 0.293 test_indirect: x->m->y       Test 1.000  0.800  0.722  0.878
#> 4 y~m 0.295 test_indirect: x->m->y       Test 1.000  0.767  0.726  0.809
#> 5 y~m 0.296 test_indirect: x->m->y       Test 1.000  0.780  0.699  0.861
#> 6 y~m 0.298 test_indirect: x->m->y       Test 1.000  0.808  0.759  0.857
#> 7 y~m 0.300 test_indirect: x->m->y       Test 1.000  0.820  0.714  0.926
#> 8 y~m 0.326 test_indirect: x->m->y       Test 1.000  0.860  0.792  0.928
#> 9 y~m 0.333 test_indirect: x->m->y       Test 1.000  0.873  0.840  0.905
#> Notes:
#> - par: The parameter being varied.
#> - es: The population value of 'par' in a trial.
#> - p.v: The proportion of valid replications.
