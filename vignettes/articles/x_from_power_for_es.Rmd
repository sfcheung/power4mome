...
#> 
#> - The range of values explored: 0.487804878048781 to 0.518543794797558 
#> - Time spent in the search: 1.665 mins 
...
#> 1  m~x 0.488 test_indirect: x->m->y       Test 1.000  0.760  0.642  0.878
#> 2  m~x 0.491 test_indirect: x->m->y       Test 1.000  0.780  0.665  0.895
#> 3  m~x 0.492 test_indirect: x->m->y       Test 1.000  0.810  0.733  0.887
#> 4  m~x 0.494 test_indirect: x->m->y       Test 1.000  0.720  0.596  0.844
#> 5  m~x 0.496 test_indirect: x->m->y       Test 1.000  0.812  0.774  0.851
#> 6  m~x 0.497 test_indirect: x->m->y       Test 1.000  0.760  0.642  0.878
#> 7  m~x 0.500 test_indirect: x->m->y       Test 1.000  0.820  0.714  0.926
#> 8  m~x 0.500 test_indirect: x->m->y       Test 1.000  0.777  0.737  0.818
#> 9  m~x 0.504 test_indirect: x->m->y       Test 1.000  0.780  0.729  0.831
#> 10 m~x 0.519 test_indirect: x->m->y       Test 1.000  0.730  0.643  0.817
#> Notes:
...
#> === Technical Information ===
#> 
#> - The range of values explored: 0.292682926829268 to 0.342635211278821 
#> - Time spent in the search: 1.656 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> 
#>    par    es                   test test_label   p.v reject r.cilo r.cihi
#> 1  y~m 0.293 test_indirect: x->m->y       Test 1.000  0.780  0.665  0.895
#> 2  y~m 0.295 test_indirect: x->m->y       Test 1.000  0.760  0.642  0.878
#> 3  y~m 0.296 test_indirect: x->m->y       Test 1.000  0.680  0.551  0.809
#> 4  y~m 0.298 test_indirect: x->m->y       Test 1.000  0.720  0.596  0.844
#> 5  y~m 0.300 test_indirect: x->m->y       Test 1.000  0.820  0.714  0.926
#> 6  y~m 0.300 test_indirect: x->m->y       Test 1.000  0.780  0.699  0.861
#> 7  y~m 0.307 test_indirect: x->m->y       Test 1.000  0.823  0.785  0.860
#> 8  y~m 0.317 test_indirect: x->m->y       Test 1.000  0.820  0.782  0.858
#> 9  y~m 0.320 test_indirect: x->m->y       Test 1.000  0.836  0.790  0.882
#> 10 y~m 0.343 test_indirect: x->m->y       Test 1.000  0.870  0.804  0.936
#> Notes:
#> - par: The parameter being varied.
#> - es: The population value of 'par' in a trial.
#> - p.v: The proportion of valid replications.
