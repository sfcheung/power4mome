...
#> 
#> - The range of values explored: 0.176930746349867 to 0.507444912661905 
#> - Time spent in the search: 2.101 mins 
...
#> Null Deviance:	    277.8 
#> Residual Deviance: 277.8 	AIC: 281.8
#> 
#> - Detailed Results:
#> 
#>    par    es                   test test_label   p.v reject r.cilo r.cihi
#> 1  m~x 0.177 test_indirect: x->m->y       Test 1.000  0.380  0.332  0.428
#> 2  m~x 0.284 test_indirect: x->m->y       Test 1.000  0.733  0.689  0.776
...
#> 7  m~x 0.410 test_indirect: x->m->y       Test 1.000  0.835  0.799  0.871
#> 8  m~x 0.412 test_indirect: x->m->y       Test 1.000  0.800  0.745  0.855
#> 9  m~x 0.414 test_indirect: x->m->y       Test 1.000  0.870  0.804  0.936
...
#> === Technical Information ===
#> 
#> - The range of values explored: 0.254636767979519 to 0.441595906965659 
#> - Time spent in the search: 1.971 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> 
#>   par    es                   test test_label   p.v reject r.cilo r.cihi
#> 1 y~m 0.255 test_indirect: x->m->y       Test 1.000  0.578  0.529  0.626
...
#> 6 y~m 0.338 test_indirect: x->m->y       Test 1.000  0.720  0.658  0.782
#> 7 y~m 0.340 test_indirect: x->m->y       Test 1.000  0.785  0.745  0.825
#> 8 y~m 0.372 test_indirect: x->m->y       Test 1.000  0.840  0.768  0.912
#> 9 y~m 0.442 test_indirect: x->m->y       Test 1.000  0.892  0.862  0.923
#> Notes:
#> - par: The parameter being varied.
#> - es: The population value of 'par' in a trial.
#> - p.v: The proportion of valid replications.
