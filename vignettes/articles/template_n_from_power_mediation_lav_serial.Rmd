...
<img src="template_n_from_power_mediation_lav_serial_model-1.png" alt="The Model"  />
...
#> x1     1 80000 0.00  1  0.00     0.01  0
#> x2     2 80000 0.00  1  0.01    -0.02  0
#> x3     3 80000 0.00  1  0.01    -0.01  0
#> m11    4 80000 0.00  1  0.01     0.00  0
#> m12    5 80000 0.00  1 -0.01     0.00  0
#> m13    6 80000 0.00  1 -0.01     0.01  0
#> m14    7 80000 0.00  1  0.00    -0.01  0
#> m21    8 80000 0.00  1 -0.01    -0.04  0
#> m22    9 80000 0.00  1  0.00     0.00  0
#> m23   10 80000 0.01  1 -0.01     0.02  0
#> m31   11 80000 0.00  1  0.01    -0.03  0
#> m32   12 80000 0.00  1 -0.01     0.00  0
#> m33   13 80000 0.01  1  0.01     0.01  0
#> m34   14 80000 0.00  1  0.02     0.00  0
#> y1    15 80000 0.00  1  0.01     0.03  0
#> y2    16 80000 0.00  1 -0.01     0.01  0
#> y3    17 80000 0.00  1  0.02    -0.02  0
#> 
#> ==== Parameter Estimates Based on All 400 Samples Combined ====
#> 
#> Total Sample Size: 80000 
#> 
...
#> 1 0.040 1.000  0.630  0.583  0.677
#> Notes:
...
#> - significantly lower than 0.800: 241
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (241): [0.710, 0.795]
#> Solution not found for the upper region.
...
<div class="figure" style="text-align: center">
<img src="template_n_from_power_mediation_lav_serial_plot-1.png" alt="Power Curve"  />
...
#> === Major Results ===
#> 
#> - Final Value (Sample Size): 241
#> 
#> - Final Estimated Power: 0.752 
#> - Confidence Interval: [0.710; 0.795]
...
#> - The range of values explored: 200 to 254 
#> - Time spent in the search: 1.361 mins 
...
#> Null Deviance:	    1876 
#> Residual Deviance: 1849 	AIC: 1853
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m1->m2->m3->y 
...
#> 1 200 0.040 1.000  0.630  0.583  0.677
#> 2 227 0.040 1.000  0.735  0.692  0.778
#> 3 241 0.040 1.000  0.752  0.710  0.795
#> 4 254 0.041 1.000  0.790  0.750  0.830
#> Notes:
...
#> - Algorithm: bisection 
#> - Tolerance for 'close enough': Within 0.02000 of 0.800 
#> - The range of values explored: 116 to 257 
...
#> [test_label]: Test 
#>     n   est   p.v reject r.cilo r.cihi
#> 1 116 0.044 1.000  0.170  0.133  0.207
#> 2 133 0.041 1.000  0.287  0.243  0.332
#> 3 254 0.041 1.000  0.790  0.750  0.830
#> 4 257 0.038 1.000  0.782  0.742  0.823
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
