...
#> 1 0.040 1.000  0.407  0.359  0.456
#> Notes:
...
#> - not significantly different from 0.800: 222 to 277
#> - significantly lower than 0.800: 222
#> - significantly higher than 0.800: 277
#> 
#> Confidence intervals of the estimated power:
#> - for the lower bound (222): [0.708, 0.792]
#> - for the upper bound (277): [0.785, 0.860]
#> 
...
#> - Confidence Interval: [0.708; 0.792]
...
#> - Time spent in the search: 52.17 secs 
...
#> 1 150 0.040 1.000  0.407  0.359  0.456
#> 2 222 0.043 1.000  0.750  0.708  0.792
#> 3 294 0.040 1.000  0.868  0.834  0.901
#> Notes:
...
#> - Time spent in the search: 1.323 mins 
#> - The final crude model for the power-predictor relation:
#> 
#> Model Type: Logistic Regression 
#> 
...
#> Null Deviance:	    1427 
#> Residual Deviance: 1419 	AIC: 1423
#> 
#> - Detailed Results:
#> 
#> [test]: test_indirect: x->m1->m2->m3->y 
#> [test_label]: Test 
#>     n   est   p.v reject r.cilo r.cihi
#> 1 271 0.038 1.000  0.800  0.761  0.839
#> 2 277 0.039 1.000  0.823  0.785  0.860
#> 3 283 0.039 1.000  0.855  0.820  0.890
#> 4 294 0.040 1.000  0.868  0.834  0.901
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - est: The mean of the estimates in a test across replications.
