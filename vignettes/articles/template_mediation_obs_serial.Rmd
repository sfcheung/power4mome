...
```{r temp_fig_flowchart, fig.cap="Common Workflow", fig.align="center", message=FALSE, echo=FALSE}
library(DiagrammeR)
...
#> - Confidence Interval: [0.750; 0.830]
...
#> - Time spent in the search: 2.421 mins
...
#> Null Deviance:	    829.4
#> Residual Deviance: 782.2 	AIC: 786.2
#>
#> - Detailed Results:
#>
#>     n                            test test_label   p.v reject r.cilo r.cihi
#> 1  50 test_indirect: x->m1->m2->m3->y       Test 1.000  0.372  0.325  0.420
#> 2  78 test_indirect: x->m1->m2->m3->y       Test 1.000  0.600  0.504  0.696
#> 3 106 test_indirect: x->m1->m2->m3->y       Test 1.000  0.790  0.750  0.830
#> 4 107 test_indirect: x->m1->m2->m3->y       Test 1.000  0.720  0.632  0.808
#> 5 111 test_indirect: x->m1->m2->m3->y       Test 1.000  0.830  0.756  0.904
#> 6 120 test_indirect: x->m1->m2->m3->y       Test 1.000  0.856  0.812  0.900
#> 7 121 test_indirect: x->m1->m2->m3->y       Test 1.000  0.850  0.815  0.885
#> 8 130 test_indirect: x->m1->m2->m3->y       Test 1.000  0.860  0.792  0.928
#> 9 138 test_indirect: x->m1->m2->m3->y       Test 1.000  0.915  0.888  0.942
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
...
#> - Confidence Interval: [0.788; 0.862]
#> - Level of confidence: 95.0%
#> - Based on 400 replications.
#>
#> === Technical Information ===
#>
#> - The range of values explored: 70 to 131
#> - Time spent in the search: 2.451 mins
#> - The final crude model for the power-predictor relation:
#>
#> Model Type: Logistic Regression
#>
...
#> 2   80 test_indirect: x->m1->m2->m3->y       Test 1.000  0.688  0.642  0.733
#> 3   90 test_indirect: x->m1->m2->m3->y       Test 1.000  0.723  0.679  0.766
#> 4   95 test_indirect: x->m1->m2->m3->y       Test 1.000  0.750  0.665  0.835
#> 5  100 test_indirect: x->m1->m2->m3->y       Test 1.000  0.700  0.610  0.790
#> 6  101 test_indirect: x->m1->m2->m3->y       Test 1.000  0.752  0.710  0.795
#> 7  102 test_indirect: x->m1->m2->m3->y       Test 1.000  0.680  0.589  0.771
#> 8  113 test_indirect: x->m1->m2->m3->y       Test 1.000  0.825  0.788  0.862
#> 9  114 test_indirect: x->m1->m2->m3->y       Test 1.000  0.817  0.769  0.865
#> 10 127 test_indirect: x->m1->m2->m3->y       Test 1.000  0.892  0.832  0.952
#> 11 131 test_indirect: x->m1->m2->m3->y       Test 1.000  0.868  0.834  0.901
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
...
#> - Time spent in the search: 2.395 mins
#> - The final crude model for the power-predictor relation:
#>
#> Model Type: Logistic Regression
#>
...
#> Degrees of Freedom: 599 Total (i.e. Null);  598 Residual
#> Null Deviance:	    818.8
#> Residual Deviance: 739.5 	AIC: 743.5
#>
#> - Detailed Results:
#>
#>     n                            test test_label   p.v reject r.cilo r.cihi
#> 1 100 test_indirect: x->m1->m2->m3->y       Test 1.000  0.460  0.411  0.509
#> 2 137 test_indirect: x->m1->m2->m3->y       Test 1.000  0.700  0.610  0.790
#> 3 142 test_indirect: x->m1->m2->m3->y       Test 1.000  0.760  0.718  0.802
#> 4 144 test_indirect: x->m1->m2->m3->y       Test 1.000  0.785  0.707  0.863
#> 5 151 test_indirect: x->m1->m2->m3->y       Test 1.000  0.809  0.760  0.858
#> 6 152 test_indirect: x->m1->m2->m3->y       Test 1.000  0.812  0.774  0.851
#> 7 160 test_indirect: x->m1->m2->m3->y       Test 1.000  0.880  0.816  0.944
#> 8 162 test_indirect: x->m1->m2->m3->y       Test 1.000  0.860  0.826  0.894
#> 9 174 test_indirect: x->m1->m2->m3->y       Test 1.000  0.900  0.841  0.959
#> Notes:
#> - n: The sample size in a trial.
#> - p.v: The proportion of valid replications.
#> - reject: The proportion of 'significant' replications, that is, the
