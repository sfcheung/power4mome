...
#' will be displayed.
#'
#' @param use_beta_nil Whether `.beta_nil.`,
#' if specified in `pop_es`, will be used
#' to set the population values of the
#' nil paths (paths fixed to zero) *not*
#' specified in `model`.
#'
#' @param beta_nil_auto_args A named list
#' of arguments to be passed to an
#' internal function (`beta_nil_from_fit_measures()`)
#' to find one possible set of values
...
#'
#' @param use_nil Whether the specification
#' stored in the attribute `model_nil`,
#' which is generated by `.beta_nil.`.
#'
#' @examples
#' # model_matrices_pop
#'
