...
#' @noRd
# No longer used. To be removed
# plot.n_from_power_not_used <- function(x,
...
# No longer used. To be removed
# plot_power_n_not_used <- function(object,
#                          type = "l",
#                          ylim = c(0, 1),
#                          ...) {
...
# No longer used. To be removed
# plot_power_curve_not_used <- function(object,
#                              power_n_fit,
#                              type = "l",
#                              lwd = 2,
#                              col = "red",
...
# No longer used. To be removed
# plot_power_n_ci_not_used <- function(object,
#                             length = .1,
#                             angle = 90,
#                             code = 3,
#                             col = "grey50",
