...
test_that("Common processes: Missing only", {
...
test_that("Common processes: Ordinal only", {
...
test_that("Common processes: Scale scores only", {
...
test_that("Common processes: Scale scores and missing", {
...
test_that("Common processes: Ordinal and missing", {
